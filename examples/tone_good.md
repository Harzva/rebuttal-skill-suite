We thank the reviewers for identifying places where the protocol and cost evidence were not sufficiently clear. We will revise the protocol summary to separate strict label-free results from diagnostic analyses, and we will add a compact cost comparison with memory class, latency relative to a named baseline, and route ratio.
