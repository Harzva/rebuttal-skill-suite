...
REQUIRED_PATHS = [
    ...
    "scripts/build_skill_registry_data.py",
    "scripts/sanitize_dashboard_data.py",
...
PRIVATE_PATTERN_ALLOWLIST = {
    ...
    Path("scripts/sanitize_dashboard_data.py"),
